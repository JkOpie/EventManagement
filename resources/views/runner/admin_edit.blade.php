          ...
          <div class="col-md-2">
            <ul class="list-group shadow-lg">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center main-color-bg">
                <a class="left-menu" href="/runner/admin/1">Profile</a>
              </li>
            </ul>
          </div>
          <div class="col-md-10">
            ...
            <div class="card bottom shadow-lg">
              ...
              <div class="card-body">
                <form  method="post" id="runner_edit"action="/runner/admin/{{$admin->id}}" autocomplete="off">
                    @csrf
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Please Username Here" name="name" value="{{$admin->name}}" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="email">Email</label>
                      <input type="email" class="form-control" placeholder="Please Email Here" name="email" value="{{$admin->email}}" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Please P.Number Here" name="phone" value="{{$admin->phone}}" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      class="datepicker-here form-control" name="date_join" placeholder="Enter Date Joined" value="{{$admin->date_join}}" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                          <input type="password" class="form-control" placeholder="Enter Password Here" id="password" name="password" value="{{$admin->text_pass}}" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                          <input type="password" class="form-control" placeholder="Enter Password Here" id="confirm_password" name="con_pass" value="{{$admin->text_pass}}" required>
                          <div class="input-group-append">
